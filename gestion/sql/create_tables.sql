...
CREATE TABLE photographers.devis_book (id BIGINT NOT NULL, devis BIGINT DEFAULT NULL, name VARCHAR(255) NOT NULL, path VARCHAR(255) DEFAULT NULL, profile SMALLINT DEFAULT 1 NOT NULL, createdAt TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id));
...
CREATE SEQUENCE photographers.devis_book_id_seq INCREMENT BY 1 MINVALUE 1 START 1;
