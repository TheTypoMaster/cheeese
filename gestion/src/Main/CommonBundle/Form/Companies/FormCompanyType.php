...
class FormCompanyType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $address = split(';;;', $company == null ? null:$company->getAddress());
        ...
        */
        ...
        $builder->add('address_numero', 'text', array(
                'label' => false,
                'data' => $address[0],
                'attr' => array(
                        'class' => 'form-control',
        ...
        $builder->add('address', 'text', array(
        		'label' => false,
        		'data' => isset($address[1]) ? $address[1]:null,
        		'attr' => array(
        				'class' => 'form-control',
    					'maxlength' => 100
        				),
        ...
        $builder->add('title_studio', 'text', array(
                'label'=> 'form.companytype.field.studio',
